...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=0.7\linewidth,height=1.5in]{obrazky-figures/single-turn.pdf}\\[1pt]
...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=\linewidth,height=1.2in]{obrazky-figures/prompt-injection.pdf}\\[1pt]
...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=0.7\linewidth,height=5.5in]{obrazky-figures/multi-turn.pdf}\\[1pt]
...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=\linewidth,height=4in]{obrazky-figures/universal-triggers.pdf}\\[1pt]
...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=0.6\linewidth,height=3in]{obrazky-figures/trojan-style.pdf}\\[1pt]
  \caption{
...
\begin{figure}[h]\centering
  \centering
  \includegraphics[width=0.5\linewidth,height=2.6in]{obrazky-figures/evasion-perturbation.pdf}\\[1pt]
