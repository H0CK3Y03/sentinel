...
Partial &
Lightweight; regex/classifier judges; limited automation~\cite{munoz2024pyrit}. \\
\addlinespace[2pt]
...
With this foundation in place, the next chapter presents a detailed survey of existing open-source red-teaming toolkits, followed by a requirements analysis and the design of the proposed modular, extensible toolkit.
