...
Common techniques include role-play (``Pretend you are …''), direct overrides (``Ignore previous instructions …''), encoding or cipher-based obfuscation (to hide disallowed instructions), and other prompt-engineering tricks~\cite{perez2022ignore}.
