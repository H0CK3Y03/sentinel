...
\begin{frame}
  ...
  \centering
      \begin{itemize}
        \item Toolkit prototype \hspace{50pt} 4 weeks
        \item Testing and debugging \hspace{18pt} 2 weeks
        \item Toolkit adjustments \hspace{40pt} 2 weeks
        \item Graphical interface \hspace{35pt} 2 weeks
        \item Finalization \hspace{77pt} 2 weeks
        \item Evaluation \hspace{80pt} 2 weeks
      \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Study the current state of research in the field of red-teaming large language models (LLM).
    \item Conduct a review of existing open-source tools and frameworks for red-teaming LLM.
    \item Design the architecture of your own red-teaming toolkit for LLM.
  \end{itemize}
\end{frame}
