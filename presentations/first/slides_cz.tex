...
\begin{frame}
  ...
  \begin{columns}
    \column{0.4\textwidth}
      ...
      \end{itemize}
    \column{0.6\textwidth}
      \includegraphics[width=\textwidth]{img/interest_in_ai.png}
  \end{columns}
\end{frame}
...
\begin{frame}
  \frametitle{Návrh}
    \includegraphics[width=\textwidth]{img/design.pdf}
\end{frame}
...
\begin{frame}
  \frametitle{Plány do budúcna}
  \centering
      \begin{itemize}
        \item Prototyp toolkitu \hspace{62pt} 4 týždne
        \item Testovanie a debugovanie \hspace{12pt} 2 týždne
        \item Úpravy toolkitu \hspace{69pt} 2 týždne
        \item Grafické rozhranie \hspace{53pt} 2 týždne
        \item Finalizácia \hspace{91pt} 2 týždne
        \item Evaluácia \hspace{93pt} 2 týždne
      \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Zadanie}
  \begin{itemize}
    \item Prostudujte současný stav výzkumu v oblasti red-teamingu velkých jazykových modelů (LLM).
    \item Proveďte rešerši existujících open-source nástrojů a frameworků pro red-teaming LLM.
    \item Navrhněte architekturu vlastního red-teaming toolkitu pro LLM.
  \end{itemize}
\end{frame}
...
\begin{frame}
  \frametitle{Referencie}
    \begin{itemize}
      \item Regulation (EU) 2024/1689 laying down harmonised rules on artificial intelligence (Artificial Intelligence Act) \url{https://eur-lex.europa.eu/eli/reg/2024/1689/oj}
      \item Graph of interest in AI from 2020 to 2024\\(Google Trends --- artificial intelligence) \url{https://trends.google.com/trends/explore/}
      \item PyRIT \url{https://arxiv.org/abs/2410.02828}
      \item MAD-MAX \url{https://arxiv.org/abs/2503.06253}
      \item garak \url{https://arxiv.org/abs/2406.11036}
    \end{itemize}
\end{frame}